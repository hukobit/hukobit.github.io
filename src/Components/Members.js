    ...
    return  (
				<div className='container'>
					<div className="text-opacity-75 text-center">
              			<h1 className='text-center display-2'>		YÖNETİM KURULU<hr/>		</h1>
					</div>
                    ...
                    <div className="text-opacity-75 text-center">
             			<h1 className='text-center display-3'>	DENETLEME KURULU<hr/>	</h1>
      				</div>
					<div className='row justify-content-around gy-5 mb-5'>
						<div className="col d-flex justify-content-center">
                      		<div className="flip-card">
                    ...
                    <h1 className='text-center display-3'>	TOPLULUK DANIŞMANI<hr/>		</h1>  
					<div className='col d-flex justify-content-center'>
                    	<div className="flip-card">
                          	<div className="flip-card-inner">
                            	<div className="flip-card-front">
					...
					<h1 className='text-center display-6'>	TOPLULUK ESKİ ÜYELERİ<hr/>		</h1>
					<div className='row'>
						{/*		2018  	*/}
                    	<div className='col d-flex justify-content-center'>
