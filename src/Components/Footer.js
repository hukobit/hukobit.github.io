              	...
              	<section className="mb-4">
                  	<div className='container'>
                    	<div className='row justify-content-center'>
							...
							<div className='col' style={{maxWidth: "46px"}}>
								<button type='button' className='btn btn-secondary'>
									<a href='https://www.linkedin.com/company/konumsalbilgihacettepe/?originalSubdomain=br' className='link-dark'>
							...
							<div className='col' style={{maxWidth: "46px"}}>
								<button type='button' className='btn btn-secondary'>
									<a href='https://www.instagram.com/konumsalbilgi/' className='link-dark'>
							...
							<div className='col' style={{maxWidth: "46px" }}>
								<button type="button" className="btn btn-secondary">
									<a href='https://github.com/hukobit' className='link-dark'>
							...
							<div className='col' style={{maxWidth: "46px"}}>
								<button type='button' className='btn btn-secondary'>
									<a href='https://discord.gg/E2zAD5BtgT' className='link-dark'>
                				...
                				<ul className='list-group'>
                  					<div className='d-inline-block'>
                    					<li className='list-group-item  justify-content-center text-center'>
                     						...
                     						<h6>	konumsalbilgitoplulugu@gmail.com	</h6>
                     					</li>
									</div>
